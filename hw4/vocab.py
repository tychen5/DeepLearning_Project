...
class Vocab(object):
    def __init__(self, min_count=5, vocab_path="./vocab", vocab_text_list=None):
        self.w2i = {}
        self.i2w = {}
        ...
        if vocab_text_list:
            ...
            self.__dict__.update(pickle.load(open("./vocab", "rb")).__dict__)
    ...
    def decode(self, index):
        assert (index < len(self.word_count)), "Index out of range!!"
