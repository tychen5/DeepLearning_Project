...
model.add(LeakyReLU())
model.add(Bidirectional(LSTM(235,dropout=0.1,recurrent_dropout=0.1,return_sequences=True)))
model.add(BatchNormalization())
# model.add(Dense(235))
model.add(LSTM(235,dropout=0.05,recurrent_dropout=0.05,return_sequences=True))
model.add(LeakyReLU())
...
model.fit(train_x_1, train_y_1, epochs=50, validation_split=0.20, callbacks=[early], batch_size=64)
